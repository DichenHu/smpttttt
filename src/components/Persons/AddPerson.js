            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-8 m-auto">
                        <h5 className="display-4 text-center">Booking Person info form</h5>
                        <hr />
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                <input type="text" className="form-control form-control-lg" 
                                placeholder="personal email/phone"
                            ...
                            <div className="form-group">
                                ...
                                placeholder="person living address"
                                name = "desc"
                            ...
                            <h6>Booking Date for visiting</h6>
                            <div className="form-group">
